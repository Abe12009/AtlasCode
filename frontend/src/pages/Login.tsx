...
import { Code, Eye, EyeOff, Loader2, Mail, Lock, AlertCircle, CheckCircle, ArrowRight, Sparkles } from 'lucide-react';
        ...
        <Card variant="elevated" padding="lg" className="bg-bg-secondary/80 backdrop-blur-xl border-border-primary/50 relative z-10">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" fullWidth className="border-border-primary/50 hover:border-primary-500/50 hover:bg-primary-500/5">
